...
import { ArrowLeft, TrendingUp, Zap, Brain, Shield, Activity, Layers, Gauge, LineChart, ArrowUpDown, Filter, Target } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-xl font-bold text-text-primary">Pipeline Guide</h1>
        <p className="mt-1 text-sm text-text-muted max-w-2xl">
          Detailed explanations of both trading strategies, with every financial
      ...
      <section className="card mb-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-base font-bold text-text-primary">Side-by-Side</h2>
        </div>
      ...
      <section className="card">
        ...
        <p className="text-xs text-text-muted mb-4">
          Every term used in the pipelines, translated. If you understand DSP, signal processing,
